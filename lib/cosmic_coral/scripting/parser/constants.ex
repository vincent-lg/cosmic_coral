defmodule CosmicCoral.Scripting.Parser.Constants do
  @moduledoc """
  ...
  import NimbleParsec
  import CosmicCoral.Scripting.Parser.Whitespace, only: [clear_whitespace: 1, check_end_symbol: 0]

  @reserved_sym ["true", "false", "not", "and", "or"]
