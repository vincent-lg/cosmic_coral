defmodule CosmicCoral.Scripting.Parser.Whitespace do
  @moduledoc """
  Parser for whitespace.

  You probably want to use the `isolate/1` combinator. In this case,
  import it from `CosmicCoral.Scripting.Parser.Constants` instead:

  ```elixir
  defmodule Parser do
    import CosmicCoral.Scripting.Parser.Constants, only: [isolate: 1]
